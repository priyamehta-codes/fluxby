...
export const en: LandingTranslationKeys = {
  ...
  legal: {
    ...
    updatesPage: {
      ...
      v140F1Desc: '18 new capabilities to discover. Check out the release notes!',
      ...
      v140F4Desc: '4 new capabilities to discover. Check out the release notes!',
      ...
      v140F7Desc: 'We\'ve got something new for you! Check the release notes for all details.',
